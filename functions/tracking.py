...
def getdata_and_save_to_sheet(symbol, position, balance_usdt_t_final, balance_usdt_t0, order, order_tp, order_sl, breakout_level,df, levier, sheet_name="tracking"):
